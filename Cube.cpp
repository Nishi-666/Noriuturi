...
static  Vertex3D g_CubeSetPosSysVerttex[] =
{
	//手前
	{D3DXVECTOR3(-0.5f , 0.5f ,-0.5f),D3DCOLOR_RGBA(255,255,255,225),D3DXVECTOR2(0,0)},//赤
	{D3DXVECTOR3(0.5f , 0.5f ,-0.5f),D3DCOLOR_RGBA(255,255,255,225),D3DXVECTOR2(0.25f,0)},
...
{
	static const D3DXVECTOR2 uv_Initsets[] = {
		D3DXVECTOR2(0,0),D3DXVECTOR2(0.25f,0),D3DXVECTOR2(0,0.25f),D3DXVECTOR2(0.25f,0),
		D3DXVECTOR2(0.25f,0.25f),D3DXVECTOR2(0,0.25f)
	};
	...
	for (int i = 0; i < 6; i++)
	{
		for (int s = 0; s < 6; s++)
		{//リセット
			g_CubeSetPosSysVerttex[i * 6 + s].TexCoord = uv_Initsets[s];
		}
	}

	static const D3DXVECTOR2 uv_offsets[] = {
		D3DXVECTOR2(0,0),D3DXVECTOR2(0.25f,0),D3DXVECTOR2(0.5f,0),D3DXVECTOR2(0.75f,0),
		D3DXVECTOR2(0,0.25f),D3DXVECTOR2(0.25f,0.25f),D3DXVECTOR2(0.5f,0.25f),D3DXVECTOR2(0.75f,0.25f),
		D3DXVECTOR2(0,0.5f),D3DXVECTOR2(0.25f,0.5f),D3DXVECTOR2(0.5f,0.5f),D3DXVECTOR2(0.75f,0.5f),
	...
	for (int i = 0; i < 6; i++)
	{
		for (int s = 0; s < 6; s++)
		{
			g_CubeSetPosSysVerttex[i * 6 + s].TexCoord += uv_offsets[Num];
		}
	}
	...
	pDevice->SetRenderState(D3DRS_LIGHTING, FALSE);
	//ポリゴンを描画！！
	pDevice->DrawPrimitiveUP(D3DPT_TRIANGLELIST, 12, &g_CubeSetPosSysVerttex, sizeof(Vertex3D));
}
