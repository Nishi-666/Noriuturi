...
void Mouse_ProcessMessage(UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_MOUSEMOVE://マウス移動値？
        break;

    case WM_LBUTTONDOWN://左ボタン押し
        gState.leftButton = true;
        break;

    case WM_LBUTTONUP://左ボタン上げ
        gState.leftButton = false;
        break;

    case WM_RBUTTONDOWN://右ボタン押し
        gState.rightButton = true;
        break;

    case WM_RBUTTONUP://右ボタン上げ
        gState.rightButton = false;
        break;

    case WM_MBUTTONDOWN://中ボタン押し？
        gState.middleButton = true;
        break;

    case WM_MBUTTONUP://中ボタン上げ？
        gState.middleButton = false;
        break;

    case WM_MOUSEWHEEL://マウススクロール
...
bool RetMouseLButton(void)
{
	return gState.leftButton;
}
bool RetMouseRButton(void)
{
	return gState.rightButton;
}
bool RetMouseMButton(void)
{
	return gState.middleButton;
}

int RetMousescrollWheelValue(void)
{
